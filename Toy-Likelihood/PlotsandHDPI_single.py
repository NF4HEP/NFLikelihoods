...
def CornerPlotter(target_samples,nf_samples,hdpis_dict_true,hdpis_dict_nf,path_to_plot,selection_list):
    ...
    labels=[r'$\mu$',r'$\delta_{4}$',r'$\delta_{7}$',r'$\delta_{31}$',r'$\delta_{62}$',r'$\delta_{86}$',r'$\delta_{91}$',r'$\delta_{92}$',r'$\delta_{93}$',r'$\delta_{94}$']
    ...
    #plt.legend(handles=[blue_line,red_line,hdpi1_line,hdpi2_line,hdpi3_line],bbox_to_anchor=(-ndims+6.0, ndims+.5, 1., 0.) ,fontsize='xx-large')
...
def GeneratePlotandHDPIResults(true_test_samples,nf_samples,path_to_result,ndims):
    ...
    path_to_corner_plot=path_to_result+'/corner_plot_hdpi_single_2.png'
    ...
    selection_list=[0,4,7,31,62,86,91,92,93,94]
...
main_path='results/test_ntestsamples_2/'
