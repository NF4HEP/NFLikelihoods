...
def SaveAllHDPI(hdpis_dict_rel_difs,ndims,ntest_samples, results_name,ks_test_list,path_to_result):
    ...
    means_hdpis_dict_rel_difs.to_csv(path_to_result+'/results_'+results_name+'_'+str(ntest_samples)+'_all_whdpi.txt',index=False)

    return

def GeneratePlotandHDPIResults(true_test_samples,nf_samples,path_to_result,ndims,ntest_samples, results_name,ks_test_list,path_to_corner_plot,path_marginal_plot):

    path_to_corner_plot=path_to_result+'/corner_plot_hdpi_single.png'
    path_marginal_plot=path_to_result+'/marginal_plot_hdpi_single.png'
...
X_data_test_file='/Users/humberto/Documents/work/NFs/github-NFlikelihoods-2/NFLikelihoods-2/Flavor-Likelihood/data/X_data_test_flavor_new_500K'
ntest_samples=500
true_test_samples=ImportTrueData(X_data_test_file)
